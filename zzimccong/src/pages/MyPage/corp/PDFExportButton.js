    ...
    try {
      ...
      for (const reservation of reservations) {
        ...
        if (restaurant) {
          ...
          // 웹사이트 정보를 텍스트로 추가하고, "이동하기" 텍스트로 링크 추가
          doc.text("웹사이트:", startX + 10, startY + textGap * 3);
          const website = restaurant.link || "N/A";
          doc.textWithLink("이동하기", startX + 38, startY + textGap * 3, { url: restaurant.link });
